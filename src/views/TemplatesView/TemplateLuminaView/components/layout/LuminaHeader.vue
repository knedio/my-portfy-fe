...
.logo {
  ...
  background: linear-gradient(90deg, var(--lumina-accent-light), var(--lumina-primary-light));
...
.mobile-menu-button {
  ...
  span {
    ...
    height: 2px;
    width: 100%;
    background-color: var(--lumina-text-primary);
    transition:
...
@media (max-width: 768px) {
  ...
  nav {
    ...
    width: 70%;
    max-width: 300px;
    background-color: var(--lumina-bg-card);
