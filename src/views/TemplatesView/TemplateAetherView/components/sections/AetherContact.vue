...
import { Mail, MapPin, Phone, FileText } from 'lucide-vue-next';
        ...
        >
          ...
          <div class="contact-methods">
            ...
            <div class="contact-method">
              ...
              <div class="contact-text">
                <span>Resume</span>
                <a :href="data?.resumeUrl" target="_blank" rel="noopener noreferrer">View Resume</a>
              </div>
            </div>
          </div>
        </div>
